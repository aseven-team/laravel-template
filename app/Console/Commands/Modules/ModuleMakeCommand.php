...
class ModuleMakeCommand extends Command
{
    ...
    protected function generateModuleManifestFile($name)
    {
        ...
        $stub = $this->laravel['files']->get($this->resolveStubPath('stubs/module.manifest.stub'));
    ...
    protected function generateControllerFile($name)
    {
        ...
        $stub = $this->laravel['files']->get($this->resolveStubPath('/stubs/module.controller.stub'));
    ...
    protected function generateRouteFile($name)
    {
        ...
        $stub = $this->laravel['files']->get($this->resolveStubPath('/stubs/module.route.stub'));
    ...
    protected function generateRouteProviderFile($name)
    {
        ...
        $stub = $this->laravel['files']->get($this->resolveStubPath('/stubs/module.provider.route.stub'));
    ...
    protected function generateProviderFile($name)
    {
        ...
        $stub = $this->laravel['files']->get($this->resolveStubPath('/stubs/module.provider.stub'));
